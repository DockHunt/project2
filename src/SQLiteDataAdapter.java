    ...
    public PurchaseModel loadPurchase(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                purchase.mCustomerID = Integer.parseInt(rs.getString("customer ID"));
                purchase.mProductID = Integer.parseInt(rs.getString("Product ID"));
                ...
                purchase.mTotal = Double.parseDouble(rs.getString("Total"));
